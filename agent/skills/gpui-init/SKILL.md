---
name: gpui-init
description: Initialize new GPUI application projects with proper structure and
  boilerplate. Use when creating a new GPUI app, setting up project structure,
  or scaffolding a cross-platform Rust desktop UI application.
---
